  ...
  render() {
    ...
    return (
      <div class="flex justify-center items-center h-screen">
        <div class="outer-div">
          <div class={`flex flex-col relative items-center rounded-md px-4 py-3 h-full mx-auto  ${modeColor} ${textColor} `}>
            {/* score display */}
            ...
            <asset-line class={`w-full ml-4 ${lineColor}`}></asset-line>
